...
d_15000 = 14.96e-4; %Density at 15000ft v
...
w_s = 1:0.25:50.75; %Wing loading assumptions for plotting graph variation****

wl_g = 28 * 4; %from graph 
...
for i = 1:200
    CLmax(i) = w_s(i) / q_s;        % cl max variation ****
end
